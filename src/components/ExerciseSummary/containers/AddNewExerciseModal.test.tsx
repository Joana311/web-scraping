    ...
    <>
      ...
      <fieldset id="tab-selection" className="max-h-min w-full">
        ...
        <div className="inline-block ">
          ...
          <label
            htmlFor="all-option"
            className="rounded-br-md  rounded full flex peer-checked:rounded-b-none /underline text-blue/70 bg-black peer-checked:no-underline peer-checked:text-blue peer-checked:bg-gray-900">
        ...
        <div className="inline-block ">
          ...
          <label htmlFor="recent-option"
            className="rounded-bl-md rounded full flex peer-checked:rounded-b-none bg-black /underline peer-checked:no-underline text-blue/70 peer-checked:text-blue peer-checked:bg-gray-900">
      ...
      <>
        <div id="title-bar" className="px-2 flex min-h-max w-full justify-between  border-green-600 bg-gray-900 rounded-tr-md pt-1">
        ...
        <section id="exercise-result-list"
          className="px-2 space-y-[.7rem] /pb-[6rem] /border-2  rounded-b-md border-dashed border-pink-600 pt-2 no-scrollbar relative flex grow snap-y snap-mandatory flex-col overflow-y-scroll overflow-x-hidden bg-gray-900"
        ...
        >
          ...
          <div id="bottom-fade"
            className="min-h-[5rem] sticky bottom-0 self-center z-30  min-w-[105%] from-gray-900 bg-gradient-to-t to-transparent flex justify-center items-start pt-2 ">
